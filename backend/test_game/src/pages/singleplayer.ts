...
export function buildSingleplayer(root: HTMLElement, handlers: Handlers): void {
  ...
  el.innerHTML = `
    <p class="sub">Singleplayer</p>
    <h1>Choose your opponent</h1>
    <div class="actions difficulty-actions">
      <button class="btn primary" data-level="training">Training<small>Current test AI · no spells</small></button>
...
export function enterSingleplayer(): void { show('singleplayer'); }
